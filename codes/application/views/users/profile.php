...
<head>
    ...
    <!-- main style -->
    <link rel="stylesheet/less" type="text/css" href="<?php base_url("assets/css/index.less") ?>" >
    <link rel="stylesheet/less" type="text/css" href="<?php base_url("assets/css/pages/homepage.less") ?>" >
    <!-- less library -->
    <script src="https://cdn.jsdelivr.net/npm/less@4" ></script>
    <!-- main script -->
    <script type="text/javascript" src="<?php base_url("assets/js/profile.js") ?>"></script>
</head>
<body>
